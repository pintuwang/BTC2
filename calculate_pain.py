...
def run_update():
    ...
    for exp in all_options:
        ...
        if m_pain:
            ...
            chain_data.append({
                ...
                "call_oi": m_call_oi, # Added for HTML columns
                "put_oi": m_put_oi,   # Added for HTML columns
    ...
    # Update Daily History Log (for trend analysis)
